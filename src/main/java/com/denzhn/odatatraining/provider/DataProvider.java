...
public class DataProvider {
    ...
    public DataProvider() {
        ...
        data.put(EntitiesEdmProvider.ES_CARS_NAME, createCars());
        data.put(EntitiesEdmProvider.ES_MANUFACTURER_NAME, createManufacturers());
    }
    ...
    private EntityCollection createCars() {
        ...
        el.setId(createId(EntitiesEdmProvider.ES_CARS_NAME, 1));
        ...
        el = new Entity()
                ...
                .addProperty(createPrimitive("Currency", "EUR"));
        el.setId(createId(EntitiesEdmProvider.ES_CARS_NAME, 2));
        entitySet.getEntities().add(el);
        ...
        el = new Entity()
                ...
                .addProperty(createPrimitive("Currency", "EUR"));
        el.setId(createId(EntitiesEdmProvider.ES_CARS_NAME, 3));
        entitySet.getEntities().add(el);
        ...
        el = new Entity()
                ...
                .addProperty(createPrimitive("Currency", "EUR"));
        el.setId(createId(EntitiesEdmProvider.ES_CARS_NAME, 4));
        entitySet.getEntities().add(el);
        ...
        el = new Entity()
                ...
                .addProperty(createPrimitive("Currency", "EUR"));
        el.setId(createId(EntitiesEdmProvider.ES_CARS_NAME, 5));
        entitySet.getEntities().add(el);

        for (Entity entity:entitySet.getEntities()) {
            entity.setType(EntitiesEdmProvider.ET_CAR.getFullQualifiedNameAsString());
        }
        return entitySet;
    }
    ...
    private EntityCollection createManufacturers() {
        ...
        el.setId(createId(EntitiesEdmProvider.ES_MANUFACTURER_NAME, 1));
        entitySet.getEntities().add(el);
        ...
        el.setId(createId(EntitiesEdmProvider.ES_MANUFACTURER_NAME, 2));
        entitySet.getEntities().add(el);

        for (Entity entity:entitySet.getEntities()) {
            entity.setType(EntitiesEdmProvider.ET_MANUFACTURER.getFullQualifiedNameAsString());
        }
        return entitySet;
    }
