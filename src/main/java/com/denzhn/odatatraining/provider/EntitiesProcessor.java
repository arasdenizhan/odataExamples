...
public class EntitiesProcessor implements EntityCollectionProcessor, PrimitiveProcessor,
        EntityProcessor, PrimitiveValueProcessor, ComplexProcessor {

    private OData odata;
    private final DataProvider dataProvider;
    private ServiceMetadata edm;

    public EntitiesProcessor(DataProvider dataProvider) {
